    ...
    <div class="translations-content-container">
      <div class="container">
        <div class="tab-content translations-content-item en visible" id="en">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                "We", "Us" or "Our" in this Agreement) refers to ClimbLine.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to ClimbLine, accessible from
                <a
                  href="https://climbline.net"
                  rel="external nofollow noopener"
                  target="_blank"
                  >https://climbline.net</a
                >
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>By email: marko.cepo.vk@gmail.com</li>
          </ul>
        </div>
      </div>
    </div>
