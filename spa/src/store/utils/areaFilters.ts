...
export function areaPassesFilter (area: Area, filters: RouteFilters, query: string) {
  if (query !== '' && !area.name.toLowerCase().includes(query.toLocaleLowerCase())) return false
