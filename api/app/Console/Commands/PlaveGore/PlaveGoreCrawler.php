    ...
    */
    public function handle()
    {
        ...
        for($i=1;$i <= self::$MOUNTAIN_COUNT; $i++) {
            ...
            $page = $this->_getPage('http://plave-gore.com/mt?id='.$i);

            if ($page == null) {
                echo ' **** http://plave-gore.com/mt?id='.$i. ' is null';
                exit;
            }
        ...
        for($i=1;$i <= self::$CRAG_COUNT; $i++) {
            $page = $this->_getPage('http://plave-gore.com/cr?id='.$i);

            if ($page == null) {
                echo ' **** http://plave-gore.com/cr?id='.$i. ' is null';
                exit;
            }
        }
